...
public class ValorantController : ControllerBase
{
    ...
    public ValorantController(PixelParadiseDbContext context, UserManager<IdentityUser> userManager)
    {
        _dbContext = context;
    ...
    [HttpGet("getValorantProfile")]
    public IActionResult GetApexProfile()
    {

            return Ok(_dbContext.ValorantMessages);
    }
}
