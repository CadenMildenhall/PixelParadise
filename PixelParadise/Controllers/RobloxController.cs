...
public class RobloxController : ControllerBase
{
    ...
    public RobloxController(PixelParadiseDbContext context, UserManager<IdentityUser> userManager)
    {
        _dbContext = context;
    ...
    [HttpGet("getRobloxProfile")]
    public IActionResult GetHellDiversProfile()
    {

            return Ok(_dbContext.RobloxMessages);
    }
}
