...
public class FortniteController : ControllerBase
{
    ...
    public FortniteController(PixelParadiseDbContext context, UserManager<IdentityUser> userManager)
    {
        _dbContext = context;
    ...
    [HttpGet("getFortniteProfile")]
    public IActionResult GetApexProfile()
    {

            return Ok(_dbContext.FortniteMessages);
    }
}
