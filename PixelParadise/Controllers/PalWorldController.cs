...
public class PalWorldController : ControllerBase
{
    ...
    public PalWorldController(PixelParadiseDbContext context, UserManager<IdentityUser> userManager)
    {
        _dbContext = context;
    ...
    [HttpGet("getPalWorldProfile")]
    public IActionResult GetHellDiversProfile()
    {

            return Ok(_dbContext.PalWorldMessages);
    }
}
